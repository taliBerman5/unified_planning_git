...
from unified_planning.io1.anml_grammar import (
    TK_ALL,
    TK_AND,
    TK_ASSIGN,
    TK_DECREASE,
...
class ANMLReader:
    """
    Class that offers the capability, with the :func:`parse_problem <unified_planning.io1.ANMLReader.parse_problem>`, to create a :class:`~unified_planning.model.Problem` from an
    `ANML` file.
